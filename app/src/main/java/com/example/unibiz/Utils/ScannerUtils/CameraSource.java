...
public class CameraSource {
    ...
    /**
     * Gets the current focus mode menu_setting_image.
     *
    ...
    /**
     * Gets the current flash mode menu_setting_image.
     *
     * @return current flash mode. null if flash mode menu_setting_image is not
    ...
    private Camera createCamera() {
        ...
        // menu_setting_image mFocusMode to the one set in the params
        ...
        // menu_setting_image mFlashMode to the one set in the params
    ...
    private class FrameProcessingRunnable implements Runnable {
         ...
         * FPS menu_setting_image above to allow for some idle time in between frames.
         */
        @Override
        public void run() {
            Frame outputFrame;
