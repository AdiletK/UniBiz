...
import com.example.unibiz.Utils.CategoryRecyclerView
import kotlinx.android.synthetic.main.dialog_views_for_all_data.*

class CategoryViewDialogs : DialogFragment(){
    ...
    companion object {
        fun display(fragmentManager: FragmentManager): CategoryViewDialogs {
            val newCategoryDialog = CategoryViewDialogs()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toolbar_views.title = getString(R.string.dialog_title_category_views)
    ...
    private fun getCategories() {
        ...
        val categories = operation.categories
        recycler_view.layoutManager = LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        val mCategoryRV = CategoryRecyclerView(context, categories)
        recycler_view.adapter = mCategoryRV
    }
}