...
import com.example.unibiz.Utils.SupplierRecyclerView
import kotlinx.android.synthetic.main.dialog_views_for_all_data.*


class SupplierViewDialogs: DialogFragment(){
    ...
    companion object {
        fun display(fragmentManager: FragmentManager): SupplierViewDialogs {
            val newDialog = SupplierViewDialogs()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toolbar_views.title = getString(R.string.dialog_title_supplier_views)
    ...
    private fun getProducts() {
        ...
        val data = operation.suppliers
        recycler_view.layoutManager = LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        val mProducts = SupplierRecyclerView(context, data)
